    ...
    <div class="search">
        <Form ref="formRef" :model="dataModel" inline>
            ...
            <FormItem label="事业部：" :label-width="80">
             ...
             <FormItem label="三级类目：" :label-width="100" v-if="type == 'businessCategory' || type == 'businessShopSKU'">
